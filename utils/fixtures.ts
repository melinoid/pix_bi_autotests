...
import CommonPage from '../pages/dev31/page.common';
import AdminSecurityRulesPage from '../pages/dev31/adminPages/page.adminSecurityRules';
import ApplicationsPage from '../pages/dev31/adminPages/page.applications';
import DirectoriesPage from '../pages/dev31/adminPages/page.directories';
import EmailReportsPage from '../pages/dev31/adminPages/page.emailReports';
import GeoserversPage from '../pages/dev31/adminPages/page.geoservers';
import GroupsPage from '../pages/dev31/adminPages/page.groups';
import LicenseBasePage from '../pages/dev31/adminPages/page.licenseBase';
import LicenseProPage from '../pages/dev31/adminPages/page.licensePro';
import LicenseRulesPage from '../pages/dev31/adminPages/page.licenseRules';
import LicensiesPage from '../pages/dev31/adminPages/page.licensies';
import LoginPage from '../pages/dev31/page.login';
import LogsPage from '../pages/dev31/adminPages/page.logs';
import ModifiersAuditPage from '../pages/dev31/adminPages/page.modifiersAudit';
import RlsOmitPage from '../pages/dev31/adminPages/page.rlsOmit';
import SecurityRulesPage from '../pages/dev31/adminPages/page.securityRules';
import SettingsPage from '../pages/dev31/adminPages/page.settings';
import SharedLinksPage from '../pages/dev31/adminPages/page.sharedLinks';
import SpecialApiPage from '../pages/dev31/adminPages/page.specialApi';
import ThemesPage from '../pages/dev31/adminPages/page.themes';
import UsefulLinksPage from '../pages/dev31/adminPages/page.usefulLinks';
import UsersImportPage from '../pages/dev31/adminPages/page.usersImport';
import UsersPage from '../pages/dev31/adminPages/page.users';
